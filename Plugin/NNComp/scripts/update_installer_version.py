...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=NNComp Demo Installer\n"
      else:
        line="OutputBaseFilename=NNComp Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the NNComp Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the NNComp installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=NNComp Demo installer\n"
     else:
       line="SetupWindowTitle=NNComp installer\n"
