...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=NNCompressor Demo Installer\n"
      else:
        line="OutputBaseFilename=NNCompressor Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the NNCompressor Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the NNCompressor installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=NNCompressor Demo installer\n"
     else:
       line="SetupWindowTitle=NNCompressor installer\n"
